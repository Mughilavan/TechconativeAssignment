CREATE TABLE user_details (id bigint NOT NULL auto_increment, user_name varchar(30),password varchar(20), email varchar(50), mobile_number varchar(10), aadhar_number varchar(12), backup_email varchar(64), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id)) engine=InnoDB;
